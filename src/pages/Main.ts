...
//     currencyRatio[to].unit:string;
//     currencyRatio[from][to]: number;
//     setTovalue(convertedAmount):Number; 
//   }  

    
  function convert(from: string, to: string):string | number {
    let amount:number = fromValue;
    console.log('from: ', from);
    console.log('amount: ', amount);
    let convertedAmount: number | string = amount * currencyRatio[from][to];
